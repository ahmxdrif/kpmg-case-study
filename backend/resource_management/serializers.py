...
class ConsultantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Consultant
        fields = ['id', 'user', 'username', 'email', 'weekly_hours_capacity', 'project', 'project_title', 'created_at', 'title', 'status_display']
...
class TimesheetSerializer(serializers.ModelSerializer):
    class Meta:
        model = Timesheet
        fields = '__all__'
        read_only_fields = ['status', 'approved_by', 'project', 'consultant']